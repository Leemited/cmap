...
<div class="my_profile <?php if($menu=="on"){?>active<?php }?>">
    ...
    <div class="mycmap">
        ...
        <div class="cmap_menu">
            ...
            <div class="cmap_menu_td cmenu6" onclick="location.href=g5_bbs_url+'/board?bo_table=databoard'">
                <img src="<?php echo G5_IMG_URL;?>/ic_databoard.svg" alt=""> <h2>게시판</h2>
            </div>
            ...
            <div class="cmap_menu_td cmenu8" onclick="location.href=g5_url+'/page/board/inquiry'">
    ...
    <?php }if($test=="mng"){?>
        ...
        <div class="search" style="position: relative;" id="msg_search">
            <form action="" method="get">
                ...
                <select name="sfl" id="sfl" class="basic_input01 width10">
                    <option value="0" <?php if($sfl=="0"){?>selected<?php }?>>준공현장 표기</option>
                    <option value="1" <?php if($sfl=="1"){?>selected<?php }?>>준공현장 미표기</option>
                </select>
