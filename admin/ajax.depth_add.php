...
if($depth==1){
    ...
    if($menu_chk==30){
        ...
        $sql = "insert into `cmap_depth2` set depth1_id='{$id}', id = '{$depth2_id}' ";
        if (!sql_query($sql)) {
            $flag = false;
        } else {
        ...
        $sql = "insert into `cmap_content` set depth1_id='{$id}', depth2_id = '{$depth2_id}', depth3_id = '', depth4_id = '',  id = '{$depth3_id}'";
        if (!sql_query($sql)) {
            $flag = false;
        }else{
        ...
        $sql = "insert into `cmap_depth3` set depth1_id='{$id}', depth2_id = '{$depth2_id}' , id = '{$depth3_id}'";
        if (!sql_query($sql)) {
            $flag = false;
        } else {
            $pk_id3 = sql_insert_id();
        ...
        $sql = "insert into `cmap_content` set depth1_id='{$id}', depth2_id = '{$depth2_id}', depth3_id = '{$depth3_id}', depth4_id = '',  id = '{$depth4_id}'";
        if (!sql_query($sql)) {
            $flag = false;
        }else{
        ...
        $sql = "insert into `cmap_depth4` set depth1_id='{$id}', depth2_id = '{$depth2_id}', depth3_id = '{$depth3_id}',  id = '{$depth4_id}'";
        if (!sql_query($sql)) {
            $flag = false;
        } else {
        ...
        $sql = "insert into `cmap_content` set depth1_id='{$id}', depth2_id = '{$depth2_id}', depth3_id = '{$depth3_id}', depth4_id = '{$depth4_id}',  id = '{$depth5_id}'";
        if (!sql_query($sql)) {
            $flag = false;
        }else{
            $pk_id5 = sql_insert_id();
...
if($depth==2){
    ...
    if($menu_chk==30) {
        ...
        $sql = "insert into `cmap_content` set depth1_id='{$parent_id}', depth2_id = '{$id}', depth3_id = '', depth4_id = '', id = '{$depth3_id}'";
        if (!sql_query($sql)) {
            $flag = false;
        }else{
            $pk_id5 = sql_insert_id();
        ...
        $sql = "insert into `cmap_content` set depth1_id='{$parent_id}', depth2_id = '{$id}', depth3_id = '{$depth3_id}', depth4_id = '', id = '{$depth4_id}'";
        if (!sql_query($sql)) {
            $flag = false;
        }else{
            $pk_id5 = sql_insert_id();
        ...
        $sql = "insert into `cmap_content` set depth1_id='{$parent_id}', depth2_id = '{$id}', depth3_id = '{$depth3_id}', depth4_id = '{$depth4_id}', id = '{$depth5_id}'";
        if (!sql_query($sql)) {
            $flag = false;
        }else{
            $pk_id5 = sql_insert_id();
...
if($depth == 3){
    ...
    if($menu_chk==302) {
        ...
        $sql = "insert into `cmap_content` set depth1_id='{$depth1_id}', depth2_id = '{$depth2_id}', depth3_id = '{$id}', depth4_id = '', id = '{$depth4_id}'";
        if (!sql_query($sql)) {
            $flag = false;
        }else{
            $pk_id5 = sql_insert_id();
...
if($depth == 5){
    ...
    if($menu_chk==30){
        ...
        $sql ="insert into `cmap_content` set depth1_id='{$depth1_id}', depth2_id = '{$depth2_id}', depth3_id = '', depth4_id = '', id = '{$id}'";
        if(!sql_query($sql)){
            $flag = false;
        }else{
            $pk_id5 = sql_insert_id();
        ...
        $sql ="insert into `cmap_content` set depth1_id='{$depth1_id}', depth2_id = '{$depth2_id}', depth3_id = '{$depth3_id}', depth4_id = '', id = '{$id}'";
        if(!sql_query($sql)){
            $flag = false;
        }else{
            $pk_id5 = sql_insert_id();
