...
if ($member["mb_id"]!=$mb["parent_mb_id"]) {
    alert("해당 계정의 관리자가 아닙니다..", G5_URL . "/page/mypage/submember_list");
}
            ...
            <div class="register_edit">
                ...
                <div class="profile_form">
                    <form action="<?php echo G5_URL;?>/page/mypage/update_profile" name="fregisterform" method="post" enctype="multipart/form-data" onsubmit="return fnSubmit(this);">
                        ...
                        <input type="hidden" name="passChk" value="false">
                        <table>
                            <tr>
                                <th>아이디 </th>
                                <td>
                                    <span style="font-size:1.2em"><?php echo $mb["mb_id"];?></span>
                                </td>
                            </tr>
                            <tr>
                                <th>성명 </th>
                                <td>
                                    <span style="font-size:1.2em"><?php echo $mb["mb_name"];?></span>
                                </td>
                            </tr>
                            <tr>
                                <th>직책</th>
                            ...
                            <tr>
                                <th>회사명</th>
                                <td>
                                    <input type="text" name="mb_1" id="reg_mb_1" value="<?php echo $mb["mb_1"];?>" class="basic_input01 width70" <?php if($mb["parent_mb_id"]){?>readonly<?php }?>>
                                </td>
                            </tr>
                            <tr>
                                <th>대표자</th>
                                <td>
                                    <input type="text" name="mb_2" id="reg_mb_2" value="<?php echo $mb["mb_2"];?>" class="basic_input01 width70" <?php if($mb["parent_mb_id"]){?>readonly<?php }?>>
                                </td>
                            </tr>
                            <tr>
                                <th>사업자 등록번호</th>
                                <td>
                                    <input type="text" name="mb_3[]" id="mb_3_1" value="<?php echo $mb_3[0];?>" class="basic_input01 width20" <?php if($mb["parent_mb_id"]){?>readonly<?php }?>>
                                    -
                                    <input type="text" name="mb_3[]" id="mb_3_2" value="<?php echo $mb_3[1];?>" class="basic_input01 width20" <?php if($mb["parent_mb_id"]){?>readonly<?php }?>>
                                    -
                                    <input type="text" name="mb_3[]" id="mb_3_3" value="<?php echo $mb_3[2];?>" class="basic_input01 width20" <?php if($mb["parent_mb_id"]){?>readonly<?php }?>>
                                </td>
                            </tr>
                            <tr>
                                <th>회사 전화번호</th>
                           ...
                           <!-- <tr>
                            ...
                            <?php if($mb["parent_mb_id"]==""){?>
                                <?php if($mb["mb_level"]==3 || $mb["mb_level"]==5){?>
                                <tr>
                                    <th>맴버쉽</th>
                                    <td>
                                        <?php if($mb["mb_paused_status"]==1){?>
                        ...
                        <div class="mypage_btns">
                            <input type="button" class="basic_btn02 width20" value="목록보기" onclick="location.href=g5_url+'/page/mypage/submember_list'">
                            <input type="submit" class="basic_btn01 width20" value="회원정보 수정">
                        </div>
                    </form>
                    <form action="<?php echo G5_URL;?>/page/mypage/submem_password_update" method="post" name="password_form" onsubmit="return fnPass();">
