                                ...
                                <tr class="start_tr <?php if($i==0){?>zero<?php }?>">
                                    ...
                                    <?php for($j=0;$j<count($list["depth1"][$i]["depth2"]);$j++){
                                        ...
                                        <td class="td_center depth3">
                                            <?php if($con["cnt"] > 0){?>
                                                <div>
                                                    <input type="text" class="basic_input01 datepicker" name="test_date[]" value="<?php echo ($submit_end[$list["depth1"][$i]["depth2"][$j]["pk_id"]])?$submit_end[$list["depth1"][$i]["depth2"][$j]["pk_id"]]:date("Y-m-d", strtotime(" +1 month"));?>">
                                                </div>
                                            <?php }else{?>
                                                <div>
                                                    <input type="text" class="basic_input01" name="test_date[]" disabled >
                                                </div>
                                            <?php }?>
                                        </td>
                                    </tr>
