    ...
    <div class="width-fixed-com">
        ...
        <div class="view">
            <div class="company_tab">
                <ul>
                    <li onclick="location.href=g5_url+'/page/company/'" >PM 회원 관리</li>
                    <li class="active">CM 회원 관리</li>
                </ul>
            </div>
            <div class="company_info" >
                ...
                <form action="<?php echo G5_URL;?>/page/company/insert_member" method="post" class="company_mb_form" onsubmit="return fnAddMember();">
                    ...
                    <table class="view_table table_head" >
                        <tr>
                            <td class="td_center" style="background-color: #ddd">CM 추가</td>
            ...
            <table class="view_table table_head" >
                ...
                <?php for($i=0;$i<count($list);$i++){?>
                    <tr class="company_mbs">
                        <td class="td_center">CM <?php echo $i+1;?></td>
                        ...
                        <td class="td_center"><?php if($list[$i]["payments"]=="활성"){?><input type="button" class="basic_btn02" style="padding:6px 10px;width:auto" value="연장하기"><?php }else{?>
