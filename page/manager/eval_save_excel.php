...
if($ie){
    $filename = iconv("utf-8","euc-kr",$const["cmap_name"]."건설사업관리시공 평가표".date('Ymdhis').".xls");
}else{
    $filename = $const["cmap_name"]."건설사업관리시공 평가표".date('Ymdhis').".xls";
}
...
<div class="message">
    <div class="pm_preview">
        ...
        <table style="border-spacing: 0;border:0.25pt solid #000;">
            <tr>
                <!--<th rowspan="2">구분</th>-->
                <th rowspan="2" style="background-color:#002060;color:#fff;text-align: center;border:0.25pt solid #fff">현장명</th>
                <th rowspan="2" style="background-color:#002060;color:#fff;text-align: center;border:0.25pt solid #fff">착공일</th>
                <th rowspan="2" style="background-color:#002060;color:#fff;text-align: center;border:0.25pt solid #fff">준공일</th>
                <th colspan="3" style="background-color:#002060;color:#fff;text-align: center;border:0.25pt solid #fff">시공평가 100(점)</th>
                <th rowspan="2" style="background-color:#002060;color:#fff;text-align: center;border:0.25pt solid #fff">시공평가점수</th>
                <th rowspan="2" style="background-color:#002060;color:#fff;text-align: center;border:0.25pt solid #fff">기간경과율</th>
            </tr>
            <tr>
            ...
            <?php for($i=0;$i<count($worklist);$i++){
                ...
                ?>
                <tr>
                    <td style="text-align: center;border:0.25pt solid #000;" ><?php echo $worklist[$i]["cmap_name"];?></td>
                    <td style="text-align: center;border:0.25pt solid #000;" ><?php echo $worklist[$i]["cmap_construct_start_temp"];?></td>
                    <td style="text-align: center;border:0.25pt solid #000;" ><?php echo $worklist[$i]["cmap_construct_finish"];?></td>
                    <td style="text-align: center;border:0.25pt solid #000;" ><?php echo $worklist[$i]["eval_01"];?></td>
                    <td style="text-align: center;border:0.25pt solid #000;" ><?php echo $worklist[$i]["eval_02"];?></td>
                    <td style="text-align: center;border:0.25pt solid #000;" ><?php echo $worklist[$i]["eval_03"];?></td>
                    <td style="text-align: center;border:0.25pt solid #000;" ><?php echo $worklist[$i]["sum"];?></td>
                    <td style="text-align: center;border:0.25pt solid #000;" ><?php echo $dayper;?></td>
                </tr>
                <?php
            } ?>
        ...
        <table class="" style="border-spacing: 0;border-top:0.25pt solid #000;border-right:0.25pt solid #000;border-bottom:0.25pt solid #000;border-left:0.25pt solid #000">
            <colgroup>
                <col width="8%">
                <col width="24%">
                <col width="3%">
            ...
            <tr>
                <!--th>직업선택</th-->
                <th rowspan="2" style="background-color:#002060;color:#fff;text-align: center;border:0.25pt solid #fff">평가항목</th>
                <th rowspan="2" style="background-color:#002060;color:#fff;text-align: center;border:0.25pt solid #fff">평가방법</th>
                <th rowspan="2" style="background-color:#002060;color:#fff;text-align: center;border:0.25pt solid #fff">배점</th>
                <th colspan="4" style="background-color:#002060;color:#fff;text-align: center;border:0.25pt solid #fff">평가등급</th>
                <th rowspan="2" style="background-color:#002060;color:#fff;text-align: center;border:0.25pt solid #fff">점수</th>
                <!--<th rowspan="2" style="background-color:#002060;color:#fff;text-align: center;border:0.25pt solid #000">평가방법</th>-->
            </tr>
            <tr>
                <th style="background-color:#002060;color:#fff;text-align: center;border:0.25pt solid #fff">우수 ( X 1.0)</th>
                <th style="background-color:#002060;color:#fff;text-align: center;border:0.25pt solid #fff">보통 ( X 0.8)</th>
                <th style="background-color:#002060;color:#fff;text-align: center;border:0.25pt solid #fff">미흡 ( X 0.6)</th>
                <th style="background-color:#002060;color:#fff;text-align: center;border:0.25pt solid #fff">불량 ( X 0.4)</th>
            </tr>
            <tr>
                <?php for($j=0;$j<count($list[$i]['depth2']);$j++) {
                ?>
                <td style="text-align: center;border:0.25pt solid #000;"  rowspan="<?php echo $list[$i]['depth2'][$j]['cnt'];?>" >
                    <strong><?php echo $list[$i]['depth2'][$j]['depth_name'];?></strong>
                </td>
                <?php for($k=0;$k<count($list[$i]['depth2'][$j]['depth3']);$k++) {
                ?>
                <td style="text-align: center;border:0.25pt solid #000;" rowspan="<?php echo $list[$i]['depth2'][$j]['depth3'][$k]['cnt'];?>">
                ...
                ?>
                <td style="text-align: center;border:0.25pt solid #000;" rowspan="<?php if($list[$i]['depth2'][$j]['depth3'][$k]['depth4'][$l]['cnt']>1){echo $list[$i]['depth2'][$j]['depth3'][$k]['depth4'][$l]['cnt'];}?>" >
                    <!-- 배점 -->
                ...
                if(!$is_member){
                    ...
                    if(count($eval)>0){
                        for($o=0;$o<count($eval);$o++){
                            ...
                            if($eval[$o]=="") continue;
                            ?>
                            <td style="text-align: center;border:0.25pt solid #000;" colspan="<?php echo $span[$o];?>" >
                                <!-- 항목 -->
                    ...
                    <?php }?>
                <?php }?>
                <td style="text-align:center;font-weight:bold;background-color:#e4f8f9;border:0.25pt solid #000;">
                    <!-- 점수 -->
        ...
        ?>
            <tr class="sum">
                <td style="background-color:#eee;border:0.25pt solid #000;text-align: center" colspan="2" >점수</td>
                <td style="background-color:#eee;border:0.25pt solid #000;text-align: center" ><?php echo $total;?></td>
                <td style="background-color:#eee;border:0.25pt solid #000" colspan="4"></td>
                <td style="background-color:#eee;border:0.25pt solid #000;text-align: center" class="td_center alltotal"><?php echo $totalScore[$i];?></td>
            </tr>
            <?php
            }?>
        </table>
