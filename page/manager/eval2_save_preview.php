...
<div class="message">
    <div class="msg_title">
        ...
        <ul>
            <!--<li onclick="">새로고침</li>-->
            <li onclick="location.href=g5_url+'/page/manager/eval2_save_excel?constids=<?php echo $constids;?>'"><img src="<?php echo G5_IMG_URL;?>/ic_save.svg" alt=""></li>
            <!-- <li>다운로드</li>-->
    ...
    <div class="pm_preview">
        <table style="width:100%;border-spacing: 0">
            <tr>
                <th colspan="15" style="font-size:15pt;font-weight:bold;border-bottom:1px solid #000"><?php echo $const['cmap_name'];?> 건설사업관리용역 평가표</th>
            </tr>
            <tr>
        ...
        <table style="width:100%;border-spacing: 0">
            <tr>
                <th style="text-align:left;" colspan="15">건설사업관리용역점수</th>
            </tr>
        </table>
        <table style="width:100%;border-spacing: 0;border-top:1px solid #000;border-right:1px solid #000;border-bottom:1px solid #000;border-left:1px solid #000">
            <colgroup>
                <col width="5%">
                <col width="*">
                <col width="6%">
            ...
            <tr>
                <th style="padding:5px;background-color:#002060;color:#fff;text-align: center;border:1px solid #fff;"  rowspan="2">구분</th>
                <th style="padding:5px;background-color:#002060;color:#fff;text-align: center;border:1px solid #fff;"  rowspan="2">현장명</th>
                <!--<th style="padding:5px;background-color:#002060;color:#fff;text-align: center;border:1px solid #fff;"  rowspan="2">착공일</th>
                <th style="padding:5px;background-color:#002060;color:#fff;text-align: center;border:1px solid #fff;"  rowspan="2">준공일</th>-->
                <th style="padding:5px;background-color:#002060;color:#fff;text-align: center;border:1px solid #fff;"  colspan="4">업체 평가(A)</th>
                <th style="padding:5px;background-color:#002060;color:#fff;text-align: center;border:1px solid #fff;"  colspan="6">기술자 평가(B)</th>
                <th style="padding:5px;background-color:#002060;color:#fff;text-align: center;border:1px solid #fff;"  rowspan="2">기간경과율</th>
            </tr>
            <tr>
                <th style="padding:5px;background-color:#002060;color:#fff;text-align: center;border:1px solid #fff;" >조직운영</th>
                <th style="padding:5px;background-color:#002060;color:#fff;text-align: center;border:1px solid #fff;" >현장지원</th>
                <th style="padding:5px;background-color:#002060;color:#fff;text-align: center;border:1px solid #fff;" >기술지원</th>
                <th style="padding:5px;background-color:#002060;color:#fff;text-align: center;border:1px solid #fff;" >소계</th>
                <th style="padding:5px;background-color:#002060;color:#fff;text-align: center;border:1px solid #fff;" >일반행정</th>
                <th style="padding:5px;background-color:#002060;color:#fff;text-align: center;border:1px solid #fff;" >시공관리</th>
                <th style="padding:5px;background-color:#002060;color:#fff;text-align: center;border:1px solid #fff;" >기술업무</th>
                <th style="padding:5px;background-color:#002060;color:#fff;text-align: center;border:1px solid #fff;" >가감점</th>
                <th style="padding:5px;background-color:#002060;color:#fff;text-align: center;border:1px solid #fff;" >시공상태</th>
                <th style="padding:5px;background-color:#002060;color:#fff;text-align: center;border:1px solid #fff;" >평가점수</th>
            </tr>
            <?php //for($i=0;$i<count($worklist);$i++){
                $eval2_total = explode("``",$evaldata["pk_score2_total"]);
                ...
                ?>
                <tr>
                    <td style="border-right:0.25pt solid #000;color:#000;text-align: center;padding:5px" >점수</td>
                    <td style="border-right:0.25pt solid #000;color:#000;text-align: center;padding:5px" ><?php echo $const["cmap_name"];?></td>
                    <!--<td style="border-right:0.25pt solid #000;color:#000;text-align: center;padding:5px" ><?php /*echo $worklist[$i]["cmap_construct_start"];*/?></td>
                    <td style="border-right:0.25pt solid #000;color:#000;text-align: center;padding:5px" ><?php /*echo $worklist[$i]["cmap_construct_finish"];*/?></td>-->
                    <td style="border-right:0.25pt solid #000;color:#000;text-align: center;padding:5px" ><?php echo $eval2_total[0];?></td>
                    <td style="border-right:0.25pt solid #000;color:#000;text-align: center;padding:5px" ><?php echo $eval2_total[1];?></td>
                    <td style="border-right:0.25pt solid #000;color:#000;text-align: center;padding:5px" ><?php echo $eval2_total[2];?></td>
                    <td style="border-right:0.25pt solid #000;color:#000;text-align: center;padding:5px" ><?php echo $total1;?></td>
                    <td style="border-right:0.25pt solid #000;color:#000;text-align: center;padding:5px" ><?php echo $eval2_total[3];?></td>
                    <td style="border-right:0.25pt solid #000;color:#000;text-align: center;padding:5px" ><?php echo $eval2_total[4];?></td>
                    <td style="border-right:0.25pt solid #000;color:#000;text-align: center;padding:5px" ><?php echo $eval2_total[5];?></td>
                    <td style="border-right:0.25pt solid #000;color:#000;text-align: center;padding:5px" ><?php echo $eval2_total[6];?></td>
                    <td style="border-right:0.25pt solid #000;color:#000;text-align: center;padding:5px" ><?php echo $eval2_total[7];?></td>
                    <td style="border-right:0.25pt solid #000;color:#000;text-align: center;padding:5px" ><?php echo $total2;?></td>
                    <td style="color:#000;text-align: center;padding:5px" ><?php echo $dayper;?></td>
                </tr>
                <?php
            //} ?>
        </table>
            ...
            <table style="width: 100%;border-spacing: 0">
                ...
                <tr>
                    <th colspan="9" style="text-align: left"><?php echo ($i+1).". ".$list[$i]["depth_name"];?></th>
                </tr>
            </table>
            <table style="width:100%;border-spacing: 0;border-top:1px solid #000;border-right:1px solid #000;border-bottom:1px solid #000;border-left:1px solid #000;">
                <colgroup>
                ...
                <tr>
                    <!--th>직업선택</th-->
                    <th  style="padding:5px;background-color:#002060;color:#fff;text-align: center;border:1px solid #fff;" rowspan="2"  colspan="4">평가항목</th>
                    <th style="padding:5px;background-color:#002060;color:#fff;text-align: center;border:1px solid #fff;" rowspan="2"  colspan="4">평가방법</th>
                    <th style="padding:5px;background-color:#002060;color:#fff;text-align: center;border:1px solid #fff;" rowspan="2">배점</th>
                    <th style="padding:5px;background-color:#002060;color:#fff;text-align: center;border:1px solid #fff;" colspan="5">평가등급</th>
                    <th style="padding:5px;background-color:#002060;color:#fff;text-align: center;border:1px solid #fff;" rowspan="2">점수</th>
                </tr>
                <tr>
                    <th style="padding:5px;background-color:#002060;color:#fff;text-align: center;border:1px solid #fff;" >우수 ( X 1.0)</th>
                    <th style="padding:5px;background-color:#002060;color:#fff;text-align: center;border:1px solid #fff;" >보통 ( X 0.9)</th>
                    <th style="padding:5px;background-color:#002060;color:#fff;text-align: center;border:1px solid #fff;" >미흡 ( X 0.8)</th>
                    <th style="padding:5px;background-color:#002060;color:#fff;text-align: center;border:1px solid #fff;" >불량 ( X 0.7)</th>
                    <th style="padding:5px;background-color:#002060;color:#fff;text-align: center;border:1px solid #fff;" >불량 ( X 0.6)</th>
                </tr>

                <tr>
                <?php for($j=0;$j<count($list[$i]['depth2']);$j++) {
                    ?>
                    <td style="padding:5px;border-right:0.25pt solid #000;border-bottom:0.25pt solid #000;color:#000;background-color:#eee;" rowspan="<?php echo $list[$i]['depth2'][$j]['cnt'];?>" colspan="4">
                        <strong><?php echo $list[$i]['depth2'][$j]['depth_name'];?></strong>
                    </td>
                    <?php for($k=0;$k<count($list[$i]['depth2'][$j]['depth3']);$k++) {
                        ?>
                        <td style="padding:5px;border-right:0.25pt solid #000;border-bottom:0.25pt solid #000;color:#000;background-color:#eee;" rowspan="<?php echo $list[$i]['depth2'][$j]['depth3'][$k]['cnt'];?>"  colspan="4">
                        ...
                        <?php for ($l=0;$l<count($list[$i]['depth2'][$j]['depth3'][$k]['depth4']);$l++) {
                            ...
                            if($list[$i]['depth2'][$j]['depth3'][$k]['depth4'][$l]['depth_name']=="0"){
                                ...
                                ?>
                                <td style="padding:5px;border-right:0.25pt solid #000;border-bottom:0.25pt solid #000;color:#000;text-align: center" rowspan="<?php if($list[$i]['depth2'][$j]['depth3'][$k]['depth4'][$l]['cnt']>1){echo $list[$i]['depth2'][$j]['depth3'][$k]['depth4'][$l]['cnt'];}?>" >
                            ...
                            for ($m = 0; $m < count($list[$i]['depth2'][$j]['depth3'][$k]['depth4'][$l]['depth5']); $m++) {
                                ...
                                if(!$is_member){
                                    ...
                                    if(count($eval)>0){
                                        for($o=0;$o<count($eval);$o++){
                                            ...
                                            ?>
                                            <td style="padding:5px;border-right:0.25pt solid #000;border-bottom:0.25pt solid #000;color:#000;text-align: center" class="depth4 scores_<?php echo $o;?> pk_<?php echo $list[$i]['depth2'][$j]['depth3'][$k]['depth4'][$l]['depth5'][$m]["pk_id"];?> <?php echo $active ?>" colspan="<?php echo $span[$o];?>" >
                                ...
                                <?php if($list[$i]['depth2'][$j]['depth3'][$k]['depth4'][$l]['depth5'][$m]['pk_id']!="22090"){?>
                                    <td style="padding:5px;border-bottom:0.25pt solid #000;background-color:#e4f8f9;font-weight:bold;" class="score_<?php echo $list[$i]['depth2'][$j]['depth3'][$k]['depth4'][$l]['depth5'][$m]['pk_id'];?> td_center" <?php if($list[$i]['depth2'][$j]['depth3'][$k]['depth4'][$l]['depth5'][$m]["pk_id"]=="22089"){?>rowspan="2" <?php }?> >
                                        <!-- 점수 -->
                                        <?php $evaltotals[$i] += (double)$scores[$list[$i]['depth2'][$j]['depth3'][$k]['depth4'][$l]['depth5'][$m]["pk_id"]]["score"];?>
                                        <?php echo round($scores[$list[$i]['depth2'][$j]['depth3'][$k]['depth4'][$l]['depth5'][$m]["pk_id"]]["score"],2);?>
                                    </td>
                                <?php }?>
                                </tr>
                ...
                <tr class="sum">
                    <td style="padding:5px;background-color:#eee;border-right:0.25pt solid #000" colspan="8" class="td_center">점수</td>
                    <td style="padding:5px;background-color:#eee;border-right:0.25pt solid #000" class="td_center" ><?php echo $total;?></td>
                    <td style="padding:5px;background-color:#eee;border-right:0.25pt solid #000" colspan="5"></td>
                    <td style="padding:5px;background-color:#eee;" class="td_center alltotal"><?php echo $evaltotals[$i];?></td>
                </tr>
                <?php
            }?>
        </table>
