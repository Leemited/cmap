        ...
        <table style="width:100%;border-spacing: 0;border-top:1px solid #000;border-right:1px solid #000;border-bottom:1px solid #000;border-left:1px solid #000">
            ...
            <?php for($i=0;$i<count($worklist);$i++){
                ...
                <tr>
                    ...
                    <td style="border-right:0.25pt solid #000;color:#000;text-align: center;padding:5px" ><?php echo $worklist[$i]["cmap_name"];?></td>
                    ...
                    <td style="border-right:0.25pt solid #000;color:#000;text-align: center;padding:5px" ><?php echo $worklist[$i]["eval_01"];?></td>
                    <td style="border-right:0.25pt solid #000;color:#000;text-align: center;padding:5px" ><?php echo $worklist[$i]["eval_02"];?></td>
                    <td style="border-right:0.25pt solid #000;color:#000;text-align: center;padding:5px" ><?php echo $worklist[$i]["eval_03"];?></td>
                    <td style="border-right:0.25pt solid #000;color:#000;text-align: center;padding:5px" ><?php echo $worklist[$i]["sum1"];?></td>
                    <td style="border-right:0.25pt solid #000;color:#000;text-align: center;padding:5px" ><?php echo $worklist[$i]["eval_04"];?></td>
                    <td style="border-right:0.25pt solid #000;color:#000;text-align: center;padding:5px" ><?php echo $worklist[$i]["eval_05"];?></td>
                    <td style="border-right:0.25pt solid #000;color:#000;text-align: center;padding:5px" ><?php echo $worklist[$i]["eval_06"];?></td>
                    <td style="border-right:0.25pt solid #000;color:#000;text-align: center;padding:5px" ><?php echo $worklist[$i]["eval_07"];?></td>
                    <td style="border-right:0.25pt solid #000;color:#000;text-align: center;padding:5px" ><?php echo $worklist[$i]["eval_08"];?></td>
                    <td style="border-right:0.25pt solid #000;color:#000;text-align: center;padding:5px" ><?php echo $worklist[$i]["sum2"];?></td>
                            ...
                            for ($m = 0; $m < count($list[$i]['depth2'][$j]['depth3'][$k]['depth4'][$l]['depth5']); $m++) {
                                ...
                                <?php if($list[$i]['depth2'][$j]['depth3'][$k]['depth4'][$l]['depth5'][$m]['pk_id']!="22090"){?>
                                    <td style="padding:5px;border-bottom:0.25pt solid #000;background-color:#e4f8f9;font-weight:bold;" class="score_<?php echo $list[$i]['depth2'][$j]['depth3'][$k]['depth4'][$l]['depth5'][$m]['pk_id'];?> td_center" <?php if($list[$i]['depth2'][$j]['depth3'][$k]['depth4'][$l]['depth5'][$m]["pk_id"]=="22089"){?>rowspan="2" <?php }?> >
                                        ...
                                        <?php echo number_format($scores[$list[$i]['depth2'][$j]['depth3'][$k]['depth4'][$l]['depth5'][$m]["pk_id"]]["score"]);?>
                                    </td>
                                <?php }?>
                                </tr>
