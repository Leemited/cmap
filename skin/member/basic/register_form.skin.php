            ...
            <div>
                ...
                <ul>
                    ...
                    <li>
                        ...
                        <input type="text" name="mb_email" value="<?php echo $email[0];?>" id="reg_mb_email" required class="frm_input email required" size="70" maxlength="100" placeholder="E-mail"> @
                        <input type="text" name="mb_email2" value="<?php echo $email[1];?>" id="reg_mb_email2" required class="frm_input email required" size="70" maxlength="100" placeholder="">
